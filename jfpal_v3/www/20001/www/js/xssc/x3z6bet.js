...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx3z6ballcollection === 'undefined' || C.xsscx3z6ballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx3z6ballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx3z6ballcollection !== 'undefined' && C.xsscx3z6ballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx3z6ballcollection.clear();
			}
		}
