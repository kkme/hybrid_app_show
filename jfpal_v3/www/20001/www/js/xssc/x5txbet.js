...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx5txballcollection === 'undefined' || C.xsscx5txballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx5txballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx5txballcollection !== 'undefined' && C.xsscx5txballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx5txballcollection.clear();
			}
		}
