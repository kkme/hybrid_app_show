...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx2zhxballcollection === 'undefined' || C.xsscx2zhxballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx2zhxballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx2zhxballcollection !== 'undefined' && C.xsscx2zhxballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx2zhxballcollection.clear();
			}
		}
