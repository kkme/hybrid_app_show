...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx2zxballcollection === 'undefined' || C.xsscx2zxballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx2zxballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx2zxballcollection !== 'undefined' && C.xsscx2zxballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx2zxballcollection.clear();
			}
		}
