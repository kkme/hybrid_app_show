...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx3z3ballcollection === 'undefined' || C.xsscx3z3ballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx3z3ballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx3z3ballcollection !== 'undefined' && C.xsscx3z3ballcollection.verify() === true){
				...
				var betArray = C.xsscx3z3ballcollection.getBetArray();
				_.each(betArray,function(v){
					C.betcollection.create(v);	
				});
				//清除选号盘集合中的数据
				C.xsscx3z3ballcollection.clear();
			}
		}
