...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx5zhxballcollection === 'undefined' || C.xsscx5zhxballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx5zhxballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx5zhxballcollection !== 'undefined' && C.xsscx5zhxballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx5zhxballcollection.clear();
			}
		}
