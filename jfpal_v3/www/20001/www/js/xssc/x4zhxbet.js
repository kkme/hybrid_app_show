...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx4zhxballcollection === 'undefined' || C.xsscx4zhxballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx4zhxballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx4zhxballcollection !== 'undefined' && C.xsscx4zhxballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx4zhxballcollection.clear();
			}
		}
