...
define(function(require,exports){
	...
	return {
		...
		editNow: function(index){
			...
			if(typeof C.xsscx1zhxballcollection === 'undefined' || C.xsscx1zhxballcollection.verify() != true){
				return;
			}
			var betArray = C.xsscx1zhxballcollection.getBetArray();
		...
		insertNewSelect: function(){
			...
			if(typeof C.xsscx1zhxballcollection !== 'undefined' && C.xsscx1zhxballcollection.verify() === true){
				...
				//清除选号盘集合中的数据
				C.xsscx1zhxballcollection.clear();
			}
		}
