...
define(function(require,exports){
	...
	C.NewUser = {
		...
		handleBet: function(obj){
			//更新成功
			if(obj.status){
				C.Config.changeUrl(localStorage.getItem('betfrom'));
			}else{
				alert(obj.resultMessage,function(){},'提示','确定');
			}
		}
	};
	...
	exports.initialize = function(){
		...
		var self = this;
		C.Config.setToolBar();
		Layout.initialize().renderView('#newUserTpl',999);
